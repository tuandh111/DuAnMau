...
//lấy thông tin đăng nhập
    ...
    public void loadDataToArray1() {
        try {
            ...
            for (O_KhoaHoc kh : listKhoaHoc) {
                if (kh.getGhiChu().trim().equalsIgnoreCase((String) cboMaKH.getSelectedItem())) {
    ...
    private void initComponents() {
        ...
        cboMaKH = new com.tuandhpc05076.Swing.Combobox();
        ...
        cboMaKH.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "t" }));
        cboMaKH.setSelectedIndex(-1);
        cboMaKH.setLabeText("Mã khóa học");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cboMaKH, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
...
// TODO add your handling code here:
    ...
    private com.tuandhpc05076.Swing.Combobox cboMaKH;
